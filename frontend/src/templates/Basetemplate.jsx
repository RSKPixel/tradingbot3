...
const Basetemplate = ({ children }) => {
    return (
        <div className='flex flex-col w-full gap-0 h-screen'>
            <div className='flex flex-row gap-4 h-10 border-b border-sky-800 bg-sky-950 items-center px-4 shadow-lg'>
                ...
                <Link to={"/intraday-emarsi-scanner"} className='text-xs font-bold cursor-pointer border rounded-lg bg-green-900 p-2 border-green-800 hover:bg-green-800 shadow-lg'>Intraday EMA/RSI Scanner</Link>
